...
class Passenger:
    def __init__(self, passenger_id, pickup_location, dropoff_location, name=None):
        self.id = passenger_id
        self.pickup_location = pickup_location
        self.dropoff_location = dropoff_location
        self.name = name  # Add name property for custom bookings


class Request:
    def __init__(self, request_id, pickup_location, dropoff_location, name=None):
        self.id = request_id
        self.pickup_location = pickup_location
        self.dropoff_location = dropoff_location
        self.name = name  # Add name property for custom bookings
